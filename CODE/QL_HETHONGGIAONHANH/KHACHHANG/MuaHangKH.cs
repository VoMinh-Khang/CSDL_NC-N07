...
namespace QL_HETHONGGIAONHANH
{
    public partial class MuaHangKH : Form
    {
        ...
        private void btn_TimMon_Click(object sender, EventArgs e)
        {
            ...
            dsMonAn.Columns[1].HeaderText = "Tên quán";

            dsMonAn.Columns[2].HeaderText = "Mã cửa hàng";
                

            
            dsMonAn.Columns[3].HeaderText = "Tên cửa hàng";
            dsMonAn.Columns[4].HeaderText = "Tên món";
            dsMonAn.Columns[5].HeaderText = "Số lượng tồn";
            ...
            // set kích thước cột
            dsMonAn.Columns[0].Width = 100;
            dsMonAn.Columns[1].Width = 200;
            dsMonAn.Columns[2].Width = 100;
            dsMonAn.Columns[3].Width = 200;
            dsMonAn.Columns[4].Width = 200;
        ...
        private void dsDoiTac_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dsCuaHang.DefaultCellStyle.Font = new Font("Segoe UI", 10);
            // set kích thước cột
            dsCuaHang.Columns[0].Width = 100;
            dsCuaHang.Columns[1].Width = 200;
            dsCuaHang.Columns[2].Width = 200;
            dsCuaHang.Columns[3].Width = 100;
